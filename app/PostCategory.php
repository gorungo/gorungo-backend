...
class PostCategory extends Model
{
    ...
    {
        return $this->hasMany('App\PostCategoryTitle', 'category_id', 'id');
    }

    public function localisedCategoryTitle()
    {
        return $this->hasOne('App\PostCategoryTitle', 'category_id', 'id')
            ->where('locale_id', LocaleMiddleware::getLocaleId());
    }

    public function categoryDescriptions()
    {
        return $this->hasMany('App\PostCategoryDescription', 'category_id', 'id');
    }

    public function localisedCategoryDescription()
    {
        return $this->hasOne('App\PostCategoryDescription', 'category_id', 'id')
            ->where('locale_id', LocaleMiddleware::getLocaleId());
    }
    ...
    {
        return $this->belongsToMany('App\Post')->using('App\Pivots\BlogCategory');
    }
